...
class LoginService {
  ...
  Future<dynamic> login(String username, String password) async {
    return http.post(Constants.SERVER_ADDRESS + Constants.LOGIN_API,
  ...
  Future<dynamic> createAccount(String username, String password) async {
    return http.post(Constants.SERVER_ADDRESS + Constants.REGISTER_API,
        body: json.encode({"usern": username, "passwd": password}),
        headers: {"Content-Type": "application/json"}).then((Response resp) {
